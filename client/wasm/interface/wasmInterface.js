...
var ASM_CONSTS = {
 ...
 21072626: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 21072709: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 21072778: () => { return window.innerWidth; },  
 21072808: () => { return window.innerHeight; },  
 21072839: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 21072986: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
